                ...
                if published_date is not None:
                    ...
                    if is_published_this_year(parsed_published_date):
                        ...
                        if article_data:
                            ...
                            cur.execute("""
                                SELECT insert_article(%s, %s, %s, %s, %s, %s, %s, %s)
                            """, (
                                title,
                                article_data['url'],
                                article_data['author'],
                                parsed_published_date,  # Ensure this is a timestamp without time zone
                                extract_number_from_string(article_data.get('number_of_views', 0)),  # This should be an integer
