      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-weather">
            ...
            <figcaption> Iasi, Copou, 30°C </figcaption>
          </div>
          <div className="footer-bottom">
            <a href="" className="footer-bottom-link">Termenii și Condițiile</a>
            <a href="" className="footer-bottom-link">Politica de confidențialitate</a>
          </div>
          <div>
