...
import "./SourceCharts.css";

function keepIntegerPart(percentage) {
  return Math.floor(percentage);
}

function TopNegativeEntities({ sourceId }) {
  ...
  return (
    <div className="top-entities-container negative-chart">
      <h2 className="top-3-text">Top 3 Cele mai negative</h2>
        ...
        {topEntities.map((entity) => (
          ...
          >
            ...
            <div className="articles-number-div">
              <p className="number-of-articles-text negative-text">{keepIntegerPart(entity.negative_percentage)}%</p>
            </div>
          </div>
        ))}
      </div>
...
export default TopNegativeEntities;
