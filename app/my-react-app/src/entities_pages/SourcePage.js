...
function formatFoundedDateToRomanian(inputDate) {
  ...
  // Create a new Date object using year, month (adjusted for 0 index), and day
            ...
            <div className="info-first-column">
              ...
              {source.founded_date && (
                <div className="profile-icon-plus-text">
                  ...
                  Fondată la {formatFoundedDateToRomanian(source.founded_date)}.
                </div>
              )}
              <div className="social-media-icons">
                <a
                  href={source.facebook_link}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                 <img src="/icons/facebook_logo.png" className="social-media-little-icon"></img>
                </a>
                <a
                  href={source.instagram_link}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img src="/icons/instagram_logo.png" className="social-media-little-icon"></img>
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                 <img src="/icons/youtube_logo.png" className="social-media-little-icon youtube"></img>
                </a>
              </div>
            </div>
              ...
              <div className="second-column-first-row">
                ...
                <div class="profile-button-div-political-party">
                  <button
                    ...
                    onClick={() => redirectToWebsite(source.website_url)}
                  >
                    Vezi site-ul
                  </button>
                </div>
